...
jQuery(window).load(function() {
   ...
   jQuery('#status-content').fadeOut();
   jQuery('#preloader-content').delay(350).fadeOut(function(){
      jQuery('.contentpanel').delay(350).css();
   });
    getTime(); 
   ...
   jQuery(window).resize(function(){
    ...
    function setNavigation() {
        ...
        $(".link-menu").each(function () {
            ...
            if (path == href) {
                if ($(this).parent().parent().attr('class')=='two_badge'){ 
