        ...
        strengthDisplay: function ($el, options) {
            ...
            $el.bind("keyup", function () {
                ...
                if ($displayContainer.length == 0) {
                    ...
                    $displayContainer.addClass("strength-meter").appendTo('#span_password');
                    $displayContainer.addClass("btn")
                }
                if (!val) {
                ...
                $displayContainer.removeClass(label.danger);
                $displayContainer.removeClass(label.warning);
                $displayContainer.removeClass(label.succes);
                $displayContainer.addClass(clss).text(text)
            })
        }
    });
