...
var CalHeight=250; // calendar height
...
var SpanBorderColor = "#222D1C";//span border color 
var SpanBgColor = "#222D1C";//span background color
var WeekChar=2;//number of character for week day. if 2 then Mo,Tu,We. if 3 then Mon,Tue,Wed.
var DateSeparator="/";//Date Separator, you can change it to "-" if you want.
var ShowLongMonth=true;//Show long month name in Calendar header. example: "January".
var ShowMonthYear=true;//Show Month and Year in Calendar header.
var MonthYearColor="whitesmoke";//Font Color of Month and Year in Calendar header.
var WeekHeadColor="#2F3D27";//Background Color in Week header.
var SundayColor="#2F3D27";//Background color of Sunday.
var SaturdayColor="#2F3D27";//Background color of Saturday.
var WeekDayColor="#2F3D27";//Background color of weekdays.
var FontColor="blue";//color of font in Calendar day cell.
var TodayColor="#FFFF33";//Background color of today.
var SelDateColor="#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor="whitesmoke";//color of font of Year selector.
var MthSelColor="whitesmoke";//color of font of Month selector if "MonthSelector" is "arrow".
...
function NewCssCal(pCtrl,pFormat,pScroller,pShowTime,pTimeMode,pHideSeconds) {
	//modification by Rudi Lee
	textField = document.getElementsByName(pCtrl);
...
function RenderCssCal(bNewCal) {
	...
	winCalData="<span style='cursor:default; left: 232px; position: relative;'>\n";
	
	if (ThemeBg==""){CalBgColor="bgcolor='"+WeekDayColor+"'"}
        
	vCalHeader="<table "+CalBgColor+" background='"+ThemeBg+"' border=0 cellpadding=0 cellspacing=0 height='250' width='250' valign='top'>\n";
	//Table for Month & Year Selector
	vCalHeader+="<tr>\n<td colspan='7'>\n<table border=0 width=242 cellpadding=0 cellspacing=0 style='position: relative; left: 7px;'>\n<tr>\n";
  ...
  {	
    if (UseImageFiles)
    {
		...
		vCalHeader+="<td><a href='javascript:void(0)' onmousedown='javascript:Cal.DecYear();RenderCssCal();' >[<]</a></td>\n";//Year scroller (decrease 1 year)
  		vCalHeader+="<td><a href='javascript:void(0)' onmousedown='javascript:Cal.DecMonth();RenderCssCal();' >[<<]</a></td>\n";//Month scroller (decrease 1 month)
  		vCalHeader+="<td width='70%' class='calR'><font color='"+YrSelColor+"'>"+Cal.GetMonthName(ShowLongMonth)+" "+Cal.Year+"</font></td>\n"//Month and Year
  		vCalHeader+="<td><a href='javascript:void(0)' onmousedown='javascript:Cal.IncMonth();RenderCssCal();' >[>>]</a></td>\n";//Month scroller (increase 1 month)
  		vCalHeader+="<td><a href='javascript:void(0)' onmousedown='javascript:Cal.IncYear();RenderCssCal();' >[>]</a></td>\n";//Year scroller (increase 1 year)
  ...
  //******************End Month and Year selector in arrow******************************
	...
	if (Cal.ShowTime) 
	{
		...
		vCalTime="\n<tr>\n<td colspan='7' align='center'><center>\n<table border='0' width='199px' cellpadding='0' cellspacing='2' style='position: relative; left: -217px;'>\n<tr>\n<td height='5px' width='"+HourCellWidth+"'>&nbsp;</td>\n";
    ...
    {	vCalTime+="<a href='javascript:void(0)' onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\");' >x</a></td>\n";//Year scroller (decrease 1 year)
	...
	if (winCal == undefined) {
	   ...
	   cssStr+= ".calR { font-size: 12px; text-align: center; font-weight: bold; color: white;}"
	   ...
	   with (span.style) {position = "absolute"; left = (xpos+8)+'px'; top = (ypos+8)+'px'; width = CalWidth;  height = "278"; border = "solid 1px " + SpanBorderColor; padding = "0pt"; cursor = "default"; backgroundColor = SpanBgColor; zIndex = 100;  }
	...
	winCal.innerHTML=winCalData + vCalTime + vCalHeader + vCalData ;
	return true;
}
